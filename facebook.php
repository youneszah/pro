...
<head>
  ...
  <style>
    :root{--bg:#003d79;--card:#fff;--muted:#5f6368;--accent:#1a73e8}
    *{box-sizing:border-box}
    ...
    input[type="gmail"],input[type="password"]{
      padding:10px 12px;border-radius:6px;
      border:1px solid #dfe1e5;font-size:15px
    }
    input:focus{
      outline:none;box-shadow:0 0 0 4px rgba(26,115,232,0.06);
...
<body>
  <div class="container">
    <div class="logo"><img src="icons/proxy-image (1).png" width='72px'></div>
